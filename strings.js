...
export default {
    ...
    joinError: `:woozy_face: **Please start a song with ${PREFIX}play.** ${PREFIX}join is for switching the song.`,
    joined: `:wave: **Switched to your VC!** Happy to see you :P`,

    noSongToLoop: `:woozy_face: **There is no song to loop.** ${PREFIX}play something first!`,
    ...
    missingVolume: `:woozy_face: **How am I supposed to know what to change the volume to?** Example usage: ${PREFIX}volume 3`,
